...
class CreateItemController:
    ...
    def __init__(self, usecase: CreateItemUsecase):
        self.CreateItemUsecase = usecase
    ...
    def __call__(self, request: IRequest) -> IResponse:
        try:
            ...
            item_image = request.data.get("item_image", None)
            ...
            viewmodel = CreateItemViewmodel(item)
